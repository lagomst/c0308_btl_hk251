...
\subsubsection{ECDSA Signing & Verification}
\begin{lstlisting}
...
function ecdsa_sign(message, generator, privkey) -> (r, s):
    ...
    loop forever:  # Repeat until a valid signature is produced
        ...
        s = (k⁻¹ · (z + r · privkey)) mod order  # Standard ECDSA formula for s
...
Link code: \texttt{https://github.com/lagomst/c0308_btl_hk251/blob/main/smc/legacy_code}
