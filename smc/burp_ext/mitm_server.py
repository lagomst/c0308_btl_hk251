...
class MITM:
    ...
    def get_message_interception(self, responses_bytes: bytes):
        parts = [
            b"A man wandering in the dark. Then he found his correspondent, a suited woman sitting beneath a lamp",
            b"He sat down and asked her \"",
            (self._last_client_msg if self._last_client_msg else b"something"),
            b"\". She answered \"",
            responses_bytes,
            b"\". But no words came from her, but from a man who has been on his trail",
            b". A man who sat between them",
        ]
        return b"".join(parts)
    ...
    def process_client_msg(self, json_data: dict):
        ...
        self._last_client_msg = plaintext
    ...
    def process_server_msg(self, json_data: dict):
        ...
        # Just for fun, let's add something to this message
        plaintext = self.get_message_interception(plaintext)
